<template>
  <div class="episodes-page page-wrapper">
    <el-card shadow="never" class="page-card">
      <template #header><span>剧集信息</span></template>
      <el-form :inline="true" class="filter-form">
        <el-form-item label="剧ID">
          <el-input v-model="query.dramaId" placeholder="请输入剧ID" clearable style="width:160px" />
        </el-form-item>
